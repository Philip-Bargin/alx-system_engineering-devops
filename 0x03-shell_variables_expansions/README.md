...
101 - Bash script that encodes and decodes text using the rot13 encryption.
102 - Bash script that prints every other line from the input, starting with the first line.
103 - Bash script that adds the two numbers stored in the environment variables WATER and STIR and prints the result.
